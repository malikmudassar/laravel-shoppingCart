...
@section('breadcrumb')
    ...
    <ol class="breadcrumb">
        ...
        <li>
            <strong>
                {{ title_case(__('Offers Management')) }}
            </strong>
        </li>
    </ol>
@endsection
...
<div class="ibox">
    ...
    <div class="ibox-title">
        <h5>Select Product for Offer</h5>
    </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td>
                                @if($offers->contains('productId',$product->id))
                                    <form action="{{ url('/admin/offers/remove/'.$product->id) }}" method="POST">
                                        {{ csrf_field() }}
