...
<div class="ibox">
    ...
    <div class="ibox-title">
        <h5>Select Products of Month</h5>
    </div>
                    ...
                    @foreach($products as $product)
                        <tr>
                            ...
                            <td>
                                ...
                                @if($pom->contains('productId',$product->id))
                                    <form action="{{ url('/admin/pom/remove/'.$product->id) }}" method="POST">
                                        {{ csrf_field() }}
                                ...
                                @else
                                    <form action="{{ url('/admin/pom') }}" method="POST">
                                        {{ csrf_field() }}
                                        <input type="hidden" name="productId" 
                                        value="{{$product->id}}" />
