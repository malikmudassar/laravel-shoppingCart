...
(function() {
  ...
  ContentEdit.Element = (function(_super) {
    ...
    Element.prototype.mount = function() {
      ...
      if(this._attributes.data_cloudinary)
      {
        this._domElement.setAttribute('data_cloudinary', this._attributes.data_cloudinary);
      }
  ...
  _Root = (function(_super) {
    ...
    _Root.prototype._onStopResizing = function(ev) {
      ...
      if(this._focused._domElement.getAttribute('data_cloudinary'))
      {
        var file_name = this._focused._attributes.src.replace(/^.*[\\\/]/, '');
        this._focused._domElement.style.backgroundImage = "url('https://res.cloudinary.com/"+window.CloudName+"/image/upload/w_"+this._focused._attributes.width+',h_'+this._focused._attributes.height+'/'+file_name+"')";
        this._focused._attributes.src = "https://res.cloudinary.com/"+window.CloudName+"/image/upload/w_"+this._focused._attributes.width+',h_'+this._focused._attributes.height+'/'+file_name;
      }
...
(function() {
  ...
  ContentTools = {
    ...
    DEFAULT_TOOLS: [['bold', 'italic', 'link', 'align-left', 'align-center', 'align-right'], ['heading', 'subheading', 'paragraph', 'unordered-list', 'ordered-list', 'table', 'indent', 'unindent', 'line-break'], ['image', 'video', 'preformatted'], ['undo', 'redo', 'remove'], ['cloudinary']],
  ...
  ContentTools.CloudinaryDialog = (function(_super) {
    __extends(CloudinaryDialog, _super);

    function CloudinaryDialog() {
      CloudinaryDialog.__super__.constructor.call(this, 'Upload image');
    ...
    CloudinaryDialog.prototype.clear = function() {
      if (this._domImage) {
    ...
    CloudinaryDialog.prototype.mount = function() {
      var domActions, domProgressBar, domTools;
      CloudinaryDialog.__super__.mount.call(this);
      ContentEdit.addCSSClass(this._domElement, 'ct-image-dialog');
      ContentEdit.addCSSClass(this._domElement, 'ct-cloudinary-dialog');
      ...
      this._domUpload.textContent = ContentEdit._('Upload new');
      domActions.appendChild(this._domUpload);
      this._domUploadFirst = this.constructor.createDiv(['ct-control', 'ct-control--text', 'ct-control--upload', 'ct-upload-first']);
      this._domUploadFirst.textContent = ContentEdit._('Upload');
      domActions.appendChild(this._domUploadFirst);
      this._domInputFirst = document.createElement('input');
      this._domInputFirst.setAttribute('class', 'ct-image-dialog__file-upload');
      this._domInputFirst.setAttribute('name', 'file');
      this._domInputFirst.setAttribute('type', 'file');
      this._domInputFirst.setAttribute('accept', 'image/*');
      this._domUploadFirst.appendChild(this._domInputFirst);
      this._domMedia = this.constructor.createDiv(['ct-control', 'ct-control--text', 'ct-control--cloudinary']);
      this._domMedia.textContent = ContentEdit._('Media Library');
      domActions.appendChild(this._domMedia);
      this._domSelectImage = this.constructor.createDiv(['ct-control', 'ct-control--text', 'ct-control--selectimage']);
      this._domSelectImage.textContent = ContentEdit._('This !');
      domActions.appendChild(this._domSelectImage);
    ...
    CloudinaryDialog.prototype.populate = function(imageURL, imageSize) {
    ...
    CloudinaryDialog.prototype.progress = function(progress) {
      if (progress === void 0) {
    ...
    CloudinaryDialog.prototype.save = function(imageURL, imageSize, imageAttrs) {
    ...
    CloudinaryDialog.prototype.state = function(state) {
      var prevState;
      if (state === void 0) {
        return this._state;
      }
    ...
    CloudinaryDialog.prototype.unmount = function() {
      CloudinaryDialog.__super__.unmount.call(this);
      this._domClear = null;
      this._domInputFirst = null;
      this._domInsert = null;
      this._domProgress = null;
      this._domUpload = null;
      this._domMedia = null;
      return this.dispatchEvent(this.createEvent('cloudinarydialog.unmount'));
    };

    CloudinaryDialog.prototype._addDOMEventListeners = function() {
      CloudinaryDialog.__super__._addDOMEventListeners.call(this);
      this._domInputFirst.addEventListener('change', (function(_this) {
        return function(ev) {
          var file;
          ...
          return _this.dispatchEvent(_this.createEvent('cloudinarydialog.getuploadedfile', {
            file: file
          }));
        };
      })(this));
      this._domSelectImage.addEventListener('click', (function(_this) {
        return function(ev) {
          var prevSelectedImage = document.querySelector(".ct-selected-cloudinary-image");
          if(!prevSelectedImage)
            return;
          console.log(prevSelectedImage.getAttribute('data-resources'));
          return _this.dispatchEvent(_this.createEvent('cloudinarydialog.fileready', {'detail':JSON.parse(prevSelectedImage.getAttribute('data-resources'))}));
        };
      })(this));
      this._domMedia.addEventListener('click', (function(_this) {
        return function(ev) {
          return _this.dispatchEvent(_this.createEvent('cloudinarydialog.medialibrary'));
        };
      })(this));
      this._domUpload.addEventListener('click', (function(_this) {
        return function(ev) {
          return _this.dispatchEvent(_this.createEvent('cloudinarydialog.gotoupload'));
        };
      })(this));
      this._domClear.addEventListener('click', (function(_this) {
        return function(ev) {
          return _this.dispatchEvent(_this.createEvent('cloudinarydialog.clear'));
        };
      })(this));
      return this._domInsert.addEventListener('click', (function(_this) {
        return function(ev) {
          return _this.dispatchEvent(_this.createEvent('cloudinarydialog.save'));
        };
      })(this));
    };

    return CloudinaryDialog;
  ...
  ContentTools.Tools.Cloudinary = (function(_super) {
    __extends(Cloudinary, _super);

    function Cloudinary() {
      return Cloudinary.__super__.constructor.apply(this, arguments);
    }

    ContentTools.ToolShelf.stow(Cloudinary, 'cloudinary');

    Cloudinary.label = 'Cloudinary';

    Cloudinary.icon = 'cloud';

    Cloudinary.canApply = function(element, selection) {
      if (element.isFixed()) {
    ...
    Cloudinary.apply = function(element, selection, callback) {
      ...
      app = ContentTools.EditorApp.get();
      modal = new ContentTools.ModalUI();
      dialog = new ContentTools.CloudinaryDialog();
      dialog.addEventListener('cancel', (function(_this) {
        return function() {
          modal.hide();
          dialog.hide();
